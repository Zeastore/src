...
# https://raw.githubusercontent.com/Zeastore/src/main/ip 
...
sleep 2
clear
wget https://raw.githubusercontent.com/Zeastore/src/main/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
